...
- **🧱 Dynamic Grid Generation** - Default 16 × 16 grid, generated entirely with JavaScript
- **🎯 Hover Drawing** - Draw by moving your cursor across the grid
- **🎨 Random Colors** - Each square gets a unique RGB color on first interaction
- **🌑 Progressive Darkening** - Each hover increases opacity by 10% until fully visible
- **🔄 Resizable Grid** - User-defined grid size up to 100 × 100
...
![Etch-a-Sketch Preview](./Final_image.png)
